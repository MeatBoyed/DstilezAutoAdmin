...
export default function ImageLoader(props: ImageLoaderProps) {
  ...
  const s3BaseUrlFull =
    "https://dstilezauto.s3.af-south-1.amazonaws.com/imagesProd";
  const cloudinaryBaseUrl = "http://res.cloudinary.com/dleilanfz/image/upload";
  const cloudinaryFullUrl =
    "http://res.cloudinary.com/dleilanfz/image/upload/f_auto,c_limit,w_128,q_auto";
