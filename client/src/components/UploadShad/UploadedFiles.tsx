...
export interface UploadedFilesCard extends React.InputHTMLAttributes<HTMLInputElement> {}

const UploadedFiles = React.forwardRef<HTMLDialogElement, UploadedFilesCard>(({ className, type, ...props }, ref) => {
...
interface ImageCard extends React.InputHTMLAttributes<HTMLDivElement> {
  provided: DraggableProvided;
  fileState: FileState;
  onDelete: () => void;
}
const ImageCard = React.forwardRef<HTMLDivElement, ImageCard>(({ className, provided, fileState, onDelete, ...props }, ref) => {
  return (
    <div
