...
const UploadShad = React.forwardRef<HTMLInputElement, UploadShadProps>(
  ({ className, type, defaultValues, children, metadata, handleChange, ...props }, ref) => {
    return (
      <FilesContextProvider metadata={metadata} defaultValues={defaultValues} onChange={handleChange}>
